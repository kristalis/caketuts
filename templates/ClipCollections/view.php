        ...
        <div class="clipCollections view content">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><?= $clipCollection->has('lib_collection') ? $this->Html->link($clipCollection->lib_collection->name, ['controller' => 'ScreenCollections', 'action' => 'view', $clipCollection->lib_collection->id]) : '' ?></td>
                </tr>
                <tr>
                    <th><?= __('Id') ?></th>
